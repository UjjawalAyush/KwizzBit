...
public class View1 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DatabaseReference databaseReference=FirebaseDatabase.getInstance().getReference().child("Quiz").child("Scores").child(firebaseUser.getUid());
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.hasChildren()) {
                    for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                        ...
                        DatabaseReference databaseReference1 = FirebaseDatabase.getInstance().getReference().child("Quiz").child("Scores").child(firebaseUser.getUid()).child(time);
